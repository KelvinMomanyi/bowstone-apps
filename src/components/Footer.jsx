...
const Footer = () => {
  return (
    <div className='w-full h-[550px] pt-10 z-0 bg-white sm:px-48 px-4'>
      <div className='flex flex-col w-full sm:justify-center justify-start sm:items-center items-start space-y-2 text-black'>
      ...
      <div className='flex sm:flex-row flex-col'>
        <div className='lg:w-1/4 flex flex-col'>
          ...
          <div className='w-1/2 flex flex-col justify-start items-start'>
            <button className='rounded-full bg-primary text-white border-primary'>Email Us</button>
          </div>

        </div>
        <div className='lg:w-1/4 font-secondary text-black' >
