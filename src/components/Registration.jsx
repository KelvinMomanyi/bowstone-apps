    ...
    <div className='w-full h-auto lg:px-56 px-6 pt-24'>
      ...
      <div className='flex lg:flex-row flex-col gap-4 font-secondary '>
        <div  className='lg:w-1/3'>
          <h1 className='font-semibold'>Simple steps to start your new business.</h1>
        ...
        <div className='lg:w-2/3'>
          <ul className='space-y-4'>
            <li className='space-y-2 font-secondary'>
               <h2 className='text-2xl font-semibold'>1. Select your structure and additional company services</h2> 
            ...
            <li className='space-y-2 font-secondary'>
                <h2 className='text-2xl font-semibold'>2. We reserve the company name</h2>
            ...
            <li className='space-y-2 font-secondary'>
                <h2 className='text-2xl font-semibold'>3. We prepare & file the paperwork with Companies Registry</h2>
            ...
            <li className='space-y-2 font-secondary'>
                <h2 className='text-2xl font-semibold'>4. Companies Registry confirms your business</h2>
            ...
            <li className='space-y-2 font-secondary'>
                <h2 className='text-2xl font-semibold'>5. Opening a corporate bank account</h2>
            ...
            <li className='space-y-2 font-secondary'>
                <h2 className='text-2xl font-semibold'>6. Securing work visa</h2>
